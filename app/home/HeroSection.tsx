...
const HeroSection = (props: Props) => {
  return (
    <div className="border-b bg-[#edf2f1]">
      <section className='grid grid-cols-1 sm:grid-cols-12 pt-6 pb-8'>
        ...
        <Image src='/Spaghetti.jpg' width={200} height={600} alt='food'></Image>
        </div>
      </section>
    </div>
  )
